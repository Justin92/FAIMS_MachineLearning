...
gscRFR = GridSearchCV(
    ...
    param_grid={
        'max_depth': (5, 15, 30, 50, 100, 150),
        'n_estimators': (200, 400, 800), #, 4000, 8000),
        'min_samples_leaf': (1, 10, 20, 40, 100), #, 500), #700, 1000),
        'min_samples_split': (2, 5, 10, 20, 40, 100), #150, 300), #500, 1000),
